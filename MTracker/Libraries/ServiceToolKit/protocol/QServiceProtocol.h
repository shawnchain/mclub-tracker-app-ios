...
extern NSString* const kQSERVICE_PROTOCOL_MTOP;
extern NSString* const kQSERVICE_PROTOCOL_DEFAULT;
 ...
 *
 */
@interface QServiceProtocol : NSObject<QServiceEndpointFilter>
